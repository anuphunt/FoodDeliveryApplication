package com.food.service.core.util;

import com.food.service.core.entity.*;
...
public class ParamAndEntityBuilder {
    ...
    public FoodEntity foodParamToEntity(FoodParam param) {
    ...
    public FoodParam foodEntityToParam(FoodEntity foodEntity) {

        FoodParam param = new FoodParam();
        param.setId(foodEntity.getId());
        param.setName(foodEntity.getName());
        param.setNickname(foodEntity.getNickname());
        param.setAddress(foodEntity.getAddress());
        param.setBiography(foodEntity.getBiography());
        param.setBackground(foodEntity.getBackground());
        param.setEmail(foodEntity.getEmail());
        param.setMobile(foodEntity.getMobile());
        param.setBirthDate(foodEntity.getBirthDate());
        param.setCountry(foodEntity.getCountry());
        param.setCreatedBy(foodEntity.getCreatedBy());
        param.setUpdatedBy(foodEntity.getUpdatedBy());
        param.setStatus(foodEntity.getStatus());
    ...
    public BookEntity bookParamToEntity(BookParam param) {
        ...
        entity.setFoods(param.getFoods().stream()
                .map(x -> foodParamToEntity(x))
    ...
    public BookParam bookEntityToParam(BookEntity entity) {
        ...
        param.setFoods(entity.getFoods().stream()
                .map(x -> foodEntityToParam(x))
                .collect(Collectors.toList()));
