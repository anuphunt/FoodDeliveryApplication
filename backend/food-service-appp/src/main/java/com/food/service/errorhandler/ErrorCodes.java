...
public class ErrorCodes {
    public interface Feature{
        String AUTHOR_ADD = "Food add";
        String AUTHOR_GET = "Food get";
        String AUTHOR_UPDATE = "Food update";
        String AUTHOR_DELETE = "Food delete";
    ...
    static {
        REASON_MAP.put(CODE.AUTHOR_NOT_FOUND,"food.not.found");
