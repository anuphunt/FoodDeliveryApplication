...
INSERT INTO `food` (`id`, `name`, `email`, `mobile`, `address`, `birthdate`, `country`, `background`, `biography`, `nickname`, `created`, `updated`, `created_by`, `updated_by`, `status`, `photo_url`)
VALUES
...
# Dump of table book_food
# ------------------------------------------------------------

DROP TABLE IF EXISTS `book_food`;

CREATE TABLE `book_food` (
  `book_id` int(11) DEFAULT NULL,
  `food_id` int(11) DEFAULT NULL,
  KEY `FKbjqhp85wjv8vpr0beygh6jsgo` (`food_id`),
  KEY `FKhwgu59n9o80xv75plf9ggj7xn` (`book_id`),
  CONSTRAINT `FKbjqhp85wjv8vpr0beygh6jsgo` FOREIGN KEY (`food_id`) REFERENCES `food` (`id`),
  CONSTRAINT `FKhwgu59n9o80xv75plf9ggj7xn` FOREIGN KEY (`book_id`) REFERENCES `book` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `book_food` WRITE;
/*!40000 ALTER TABLE `book_food` DISABLE KEYS */;

INSERT INTO `book_food` (`book_id`, `food_id`)
VALUES
	(1,1);

/*!40000 ALTER TABLE `book_food` ENABLE KEYS */;
UNLOCK TABLES;
