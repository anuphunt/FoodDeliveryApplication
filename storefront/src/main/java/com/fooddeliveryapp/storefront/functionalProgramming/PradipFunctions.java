...
public class PradipFunctions {
    ...
    public static BiFunction<List<Food>,LocalDate,List<Food>> foodlist=(food, date)->food.stream()
        .filter((f)->f.getRating()>=4 && date.getMonth()==LocalDate.now().getMonth())
        .limit(10)
...
//Get all restaurants that have rating < 2 rated by users.
    ...
    public static void main(String[] args) {
        Food food1=new Food("1","B",5.0,"Yummy","sasa","12",5,LocalDate.now());
        Food food2=new Food("1","B",5.0,"Yummy","sasa","12",5,LocalDate.now());
        Food food3=new Food("1","B",5.0,"Yummy","sasa","12",5,LocalDate.now());
        Food food4=new Food("2","A",5.0,"Yummy","sasa","12",4,LocalDate.now());
        Food food5=new Food("2","A",5.0,"Yummy","sasa","12",4,LocalDate.now());
...
//        List<Order> orders = Arrays.asList( order1,order2,order3);
        foodlist.apply(foods,LocalDate.now());
